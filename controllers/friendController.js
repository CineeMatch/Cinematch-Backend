...
export const createFriend = async (req, res) => {
    try {
        ...
        const newFriend = await Friend.create({ user_id: userId, friend_id: friend_id, status: "pending" });
...
export const acceptFriendRequest = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: "Friend request accepted and mutual friendship created." });
    } catch (error) {
